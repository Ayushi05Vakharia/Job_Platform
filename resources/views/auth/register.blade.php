...
<div class="d-flex justify-content-center align-items-center p-5"
 style="display: flex; justify-content: center; align-items: center; min-height: 100vh; background: linear-gradient(to right,rgb(214, 212, 216),rgb(175, 181, 193));">
    <div class="card shadow-lg border-0 rounded-4 w-100" style="max-width: 550px;width: 50%; background-color: #ffffffee; padding: 30px;">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4" >
            ...
            <div class="form-group mb-2" style="display: flex; justify-content: space-between;">
                ...
                <input type="email" name="email" class="form-control rounded-pill px-4 py-2" placeholder="example@mail.com" value="{{ old('email') }}" required>
            ...
            <div class="form-group mb-2" style="display: flex; justify-content: space-between;">
                <label class="fw-semibold text-gray-800"><i class="bi bi-shield-lock-fill me-2"></i>Confirm Password</label>
                <input type="password" name="password_confirmation" class="form-control rounded-pill px-4 py-2" placeholder="Repeat password" required>
            ...
            <div class="form-group mb-2" style="display: flex; justify-content: space-between;">
                ...
                <input type="role" name="role" class="form-control rounded-pill px-4 py-2" placeholder="viewer or poster" value="{{ old('role') }}" required>
                @error('role') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
            </div>

            <!-- Register Button -->
            <button type="submit" class="btn btn-primary w-full rounded-pill py-2 mt-4 text-blue fw-bold">Register Now</button>
        </form>
    </div>
</div>
@endsection
